      ...
      >
        <div class="row q-col-gutter-sm">
          ...
          <q-input
            ...
            outlined
            label="Visitante"
            placeholder="Nome do visitante / Celular / Sexo / Idade"
            v-model="visitanteInput"
            hint="Ex: João da Silva / 4491234555 / M / 35"
  ...
  try {
    if (idUpdate.value) {
      ...
      const celebracao = {
        ...
        tipo_celebracao_id: form.value.tipo_celebracao_id,
      }
